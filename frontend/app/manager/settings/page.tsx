    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Configure the system prompt used to screen resumes against a job posting — this
          controls how candidates are scored and matched, not resume-writing feedback.
        </p>
      </div>
